...
-(void)setup{
    ...
    [leftTabButton setImage:[[UIImage imageNamed:@"left_tab"]YIMImageWithTintColor:self.setting.tintColor] forState:UIControlStateSelected];
    [self.contentView addSubview:leftTabButton];
    
    UIButton *rightTabButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [rightTabButton setImage:[UIImage imageNamed:@"right_tab"] forState:UIControlStateNormal];
    [rightTabButton setImage:[[UIImage imageNamed:@"right_tab"]YIMImageWithTintColor:self.setting.tintColor] forState:UIControlStateSelected];
